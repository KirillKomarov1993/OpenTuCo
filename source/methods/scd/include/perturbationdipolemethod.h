...
class PerturbationDipoleMethod
{
private:
    double chi_;
    double r12_norm, r12in3, r23_norm, r23in3, r34_norm, r34in3;
    Vector p_;
    Vector r12, n12, r23, n23, r34, n34;
public:
    double lambda;
    Cluster* cluster;
    PerturbationDipoleMethod(Cluster *_cluster) :
        cluster(_cluster)
    {
        //space = system->medium->space;
    }
    Dipole* getPerturbationDipole(Particle* _particle, HomogeneousField* _field);
    virtual void computer(HomogeneousField* _field);
};
